...
-- ========================================
-- ESP Tab Logic & UI (VISUALS) 👁️
-- ========================================

-- Periksa apakah tab 'Esp' ada. Jika tidak ada, jangan lanjutkan.
if Tabs.Esp then
...
-- Function to update highlights based on the value of _G.ESP_Enabled
